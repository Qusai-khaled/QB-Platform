			...
			<div id="nav">
				...
				<div id="nav-top">
					<div class="container">
						<!-- social -->
						<ul class="nav-social">
					        <li><a href="/website"><i  ></i> <h4>QB PLATFORM</h4> </a></li>
            ...
            <div class="card text-center">
                <div class="card-body ">
                    ...
                    <div class="row mt-5 mb-5 justify-content-center">
                        <h1 class="display-1">You are logged in!</h1>
                    </div>
                    <div class="row mt-5 mb-5 justify-content-center ">
                        <h3 class="mr-5"> <a href="{{route('website')}}">Go to Home Page</a></h3>
                        <h3 class="ml-5 "> <a href="{{route('edit')}}">Go to profile edit</a></h3>
                    </div>
                </div>
            </div>
        </div>
